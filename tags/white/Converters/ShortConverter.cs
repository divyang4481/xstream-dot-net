...
{
	/// <summary>
	/// Converts an short (System.Int16) to xml and back.
	/// </summary>
	internal class ShortConverter : IConverter
	{
		private static readonly Type __type = typeof( short );
		...
		{
			return short.Parse( xml.InnerText );
		}
	}
}
