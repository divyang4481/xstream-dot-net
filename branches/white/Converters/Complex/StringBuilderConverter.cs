...
namespace Xstream.Core.Converters.Complex
{
	/// <summary>
	/// Converts a StringBuilder to XML and back.
	/// </summary>
	internal class StringBuilderConverter: IConverter
	{
		private static readonly Type __type = typeof( StringBuilder );
		...
		public void Register(IMarshalContext context)
		{
			...
			context.Alias( "StringBuilder", __type );
		}
