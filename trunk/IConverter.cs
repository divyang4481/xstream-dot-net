...
namespace Xstream.Core
{
	...
	public interface IConverter
	{
		...
		/// </summary>
		void Register( MarshalContext context );

		/// <summary>
		/// Converts the object passed in to its XML representation.
		/// The XML string is written on the XmlTextWriter.
		/// </summary>
		void ToXml( object value, FieldInfo field, XmlTextWriter xml, MarshalContext context );
		...
		object FromXml( object parent, FieldInfo field, Type type, XmlNode xml, MarshalContext context );
	}
